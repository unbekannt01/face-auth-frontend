    ...
    <div style={styles.container}>
      ...
      <nav
        style={{
          ...
          boxShadow:
            scrollY > 50 ? "0 8px 32px rgba(0, 255, 157, 0.1)" : "none",
        }}
      >
            ...
            <button
              ...
              onMouseEnter={(e) => {
                ...
                e.target.style.boxShadow =
                  "0 20px 60px rgba(0, 255, 157, 0.4), 0 0 80px rgba(0, 255, 157, 0.2)";
              }}
              onMouseLeave={(e) => {
          ...
          <div style={styles.ctaContent}>
            ...
            <button
              ...
              onMouseEnter={(e) => {
                ...
                e.target.style.boxShadow =
                  "0 25px 70px rgba(0, 255, 157, 0.5), 0 0 100px rgba(0, 255, 157, 0.3)";
              }}
              onMouseLeave={(e) => {
                e.target.style.transform = "translateY(0) scale(1)";
...
const styles = {
  ...
  gradientOrb1: {
    ...
    right: "-5%",
    background:
      "radial-gradient(circle, rgba(0, 255, 157, 0.15), transparent 70%)",
    borderRadius: "50%",
    filter: "blur(80px)",
  ...
  cursorGlow: {
    ...
    height: "300px",
    background:
      "radial-gradient(circle, rgba(0, 255, 157, 0.08), transparent 70%)",
    borderRadius: "50%",
    pointerEvents: "none",
    transform: "translate(-50%, -50%)",
    filter: "blur(40px)",
  ...
  scannerCard: {
    ...
    position: "relative",
    background:
      "linear-gradient(135deg, rgba(0, 255, 157, 0.05), rgba(0, 212, 255, 0.05))",
    ...
    boxShadow:
      "0 30px 80px rgba(0, 255, 157, 0.2), inset 0 1px 0 rgba(255, 255, 255, 0.1)",
    padding: "40px 30px",
  },
  scannerGlow: {
    position: "absolute",
    inset: 0,
    background:
      "radial-gradient(circle at 50% 30%, rgba(0, 255, 157, 0.15), transparent 60%)",
  ...
  faceIconCircle: {
    ...
    borderRadius: "50%",
    background:
      "linear-gradient(135deg, rgba(0, 255, 157, 0.3), rgba(0, 212, 255, 0.2))",
  ...
  bentoCard: {
    background:
      "linear-gradient(135deg, rgba(0, 255, 157, 0.05), rgba(0, 212, 255, 0.03))",
  ...
  ctaGlow: {
    ...
    inset: 0,
    background:
      "radial-gradient(circle at center, rgba(0, 255, 157, 0.2), transparent 70%)",
    filter: "blur(80px)",
    animation: "pulse 4s ease-in-out infinite",
    zIndex: 1,
  },
